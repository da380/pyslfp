...
op4 = sl.grace_operator(op3.codomain, observation_degree)
...
# Form also a mapping from the model space to the potential fields
P = op3.codomain.subspace_projection(2)
A_phi = P @ op3 @ op2 @ op1


# Define the data error statistics
phi_std_dev_m = 0.00001
phi_std_dev = fp.gravitational_acceleration * phi_std_dev_m / fp.length_scale
data_error_measure = inf.GaussianMeasure.from_standard_deviation(
    data_space, phi_std_dev
)
