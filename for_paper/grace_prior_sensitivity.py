...
For each sweep, two figures are generated:
  1. Maps (3x2 grid): True Earth Model + 5 Posterior Expectation maps.
...
def main():
    ...
    print("Generating True Earth Model and Synthetic Data...")
    ...
    for sweep_name, configs in sweeps.items():
        ...
        axes_maps[0].set_title("True Earth Model", fontsize=14, fontweight="bold")
        ...
        for i, config in enumerate(configs):
            ...
            initial_prior_base, test_prior_base, test_noise, _ = utils.build_measures(
                ...
                config["scale"],
                config["std"],
                config.get("noise_scale_fac", base_noise_scale_fac),
                config["noise_fac"],
            )
