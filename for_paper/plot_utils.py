...
def plot_normalized_mc_errors(
    ...
    *,
    ...
    and 1-sigma / 2-sigma background shading, handling normalizations internally.
    """
    # 1. Normalize the errors
    errs_x = raw_errs_x / std_x
    errs_y = raw_errs_y / std_y

    # 2. Normalize the analytical mean and covariance
    ...
    # Dynamically calculate symmetrical plot limits
